...
builder_rho_0.append_set_options_op(med_threshold=100)
...
builder_rho_0.append_hashx_signer(hash_x1, 99)
...
builder_gamma_0.append_set_options_op(med_threshold=100)
...
builder_gamma_0.append_hashx_signer(hash_x2, 99)
