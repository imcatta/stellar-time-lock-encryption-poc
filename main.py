...
builder_rho_gamma.append_create_account_op(kp_rho.address().decode(), '102.50008')
builder_rho_gamma.append_create_account_op(kp_gamma.address().decode(), '102.50008')
